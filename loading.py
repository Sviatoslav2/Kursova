...
begin = URL.begin
type = input("Type: ",)
url = URL.URLclass(location=str(begin[0])+str(begin[1]),type="museum",rad =5000,Yure_key="AIzaSyD3jLGsllUAVZzF-t1NyDDg3xQBKtdUQgM",BASE_URL = "https://maps.googleapis.com/maps/api/place/radarsearch/json?")
